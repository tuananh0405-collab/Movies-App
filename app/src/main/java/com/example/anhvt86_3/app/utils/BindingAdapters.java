...
public class BindingAdapters {
    ...
    @InverseMethod("stringToBooleanMale")
    public static String booleanToString(boolean isChecked) {
        return isChecked ? "male" : "female";
    }
    @InverseMethod("stringToBooleanFemale")
    public static String booleanToString2(boolean isChecked) {
        return isChecked ? "female" : "male";
    }

    public static boolean stringToBooleanMale(String gender) {
