...
import com.example.anhvt86_3.databinding.FragmentHostAboutBinding;


public class HostAboutFragment extends Fragment {

    private FragmentHostAboutBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentHostAboutBinding.inflate(inflater, container, false);

        NavHostFragment nestedNavHostFragment = (NavHostFragment) getChildFragmentManager().findFragmentById(R.id.nested_nav_host_fragment_about);
